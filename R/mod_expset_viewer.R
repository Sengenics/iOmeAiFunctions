# mod_expset_viewer.R ####
# ExpressionSet Viewer Module with Integrated Selector
...
mod_expset_viewer_server <- function(id, 
	...
	moduleServer(id, function(input, output, session) {
		...
		output$eset_info <- renderPrint({
			...
			cat("Assay: ", current_expset_name(), "\n")
			cat("Samples: ", ncol(current_expset()), "\n")
			cat("Features: ", nrow(current_expset()), "\n")
		})
